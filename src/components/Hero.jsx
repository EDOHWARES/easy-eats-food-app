...
const Hero = () => {
  return (
    <div className='max-w-[1640px] mx-auto p-4 group'>
      <div className='max-h-[500px] relative'>
        {/* Overlay */}
        <div className='absolute w-full h-full text-gray-200 max-h-[500px] bg-black/75 group-hover:bg-black/50 duration-500 flex flex-col justify-center'>
